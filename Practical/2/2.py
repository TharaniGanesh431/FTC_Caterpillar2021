...
#cv2.drawContours(img, contour_check,-1,(0,0,255),0)
grey1=cv2.cvtColor(img,cv2.COLOR_BGR2GRAY)

cv2.fillPoly(temp,[nes_con],(255,255,255))
mask3=cv2.bitwise_or(mask,~temp)

##cv2.imshow('temp2',mask3)
...
mask2= mask3[topy:bottomy+1, topx:bottomx+1]
mask2=~mask2


cv2.imwrite('mask2.jpg',mask2)
path = r'F:\Projects\Caterpillar\Practical\2\mask2.jpg'
...
grey2=cv2.cvtColor(mask2,cv2.COLOR_BGR2GRAY)

cv2.imshow("inv_img.jpg", grey2)
contour2,hierarchy2=cv2.findContours(grey2,cv2.RETR_TREE, cv2.CHAIN_APPROX_SIMPLE)
...
cv2.drawContours(img, contour_arr,-1,(255,255,255),3)
